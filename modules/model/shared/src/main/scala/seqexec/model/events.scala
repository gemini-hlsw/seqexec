...
object events {
  ...
  final case class ObservationProgressEvent(progress: Progress) extends SeqexecEvent
  ...
  final case class GuideConfigUpdate(telescope: TelescopeGuideConfig) extends SeqexecEvent
  ...
  final case class AlignAndCalibEvent(step: Int) extends SeqexecEvent
