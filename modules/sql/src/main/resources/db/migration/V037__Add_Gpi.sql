...
COPY e_gpi_disperser(id, short_name, long_name, obsolete) FROM stdin;
PRISM	Prism	Prism	f
WOLLASTON	Wollaston	Prism	f
\.
...
--
-- Name: e_gpi_artificial_source; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE e_gpi_artificial_source (
  id          identifier  PRIMARY KEY,
  short_name  text        NOT NULL,
  long_name   text        NOT NULL,
  value       boolean     NOT NULL
...
ALTER TABLE e_gpi_artificial_source OWNER TO postgres;

--
-- Data for Name: e_gpi_artificial_source; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY e_gpi_artificial_source(id, short_name, long_name, value) FROM stdin;
On	"On"	"On"	true
Off	"Off"	"Off"	false
\.
