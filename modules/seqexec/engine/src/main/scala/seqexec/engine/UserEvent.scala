...
final case class Load(id: Observation.Id, sequence: Sequence) extends UserEvent[Nothing] {
  val user: Option[UserDetails] = None
}
final case class Unload(id: Observation.Id) extends UserEvent[Nothing] {
  val user: Option[UserDetails] = None
}
...
final case class SetObserver(id: Observation.Id, user: Option[UserDetails], name: Observer) extends UserEvent[Nothing]
...
final case class GetSeqState[D <: Engine.Types](id: Observation.Id, f: Sequence.State => Option[Stream[IO, Event[D]]]) extends UserEvent[D] {
  val user: Option[UserDetails] = None
}
...
final case class ActionStop[D <: Engine.Types](id: Observation.Id, f: Sequence.State => Option[Stream[IO, Event[D]]]) extends UserEvent[D] {
  val user: Option[UserDetails] = None
}
