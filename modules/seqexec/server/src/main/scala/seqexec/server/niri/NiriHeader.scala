  ...
  def header[F[_]: Sync](inst: InstrumentSystem[F], instReader: NiriKeywordReader[F],
    ...
    override def sendBefore(obsId: Observation.Id, id: ImageFileId): F[Unit] =
      sendKeywords(id, inst, List(
        ...
        buildInt32S(tcsKeywordsReader.niriInstPort, KeywordName.INPORT),
        ...
        buildStringS(tcsKeywordsReader.ut, KeywordName.TIME),
    ...
    override def sendAfter(id: ImageFileId): F[Unit] =
      sendKeywords(id, inst, List(
        ...
        buildStringS(tcsKeywordsReader.ut, KeywordName.UTEND),
