...
object Parsers {
  ...
  object GmosNorth {
    ...
    val disperserTable: List[(String, String, Option[GmosNorthDisperser])] =
      List(
    ...
    val filterTable: List[(String, String, Option[GmosNorthFilter])] =
      List(
    ...
    val fpuTable: List[(String, String, Option[GmosNorthFpu])] =
      List(
  ...
  object GmosSouth {
    ...
    val disperserTable: List[(String, String, Option[GmosSouthDisperser])] =
      List(
    ...
    val filterTable: List[(String, String, Option[GmosSouthFilter])] =
      List(
    ...
    val fpuTable: List[(String, String, Option[GmosSouthFpu])] =
      List(
