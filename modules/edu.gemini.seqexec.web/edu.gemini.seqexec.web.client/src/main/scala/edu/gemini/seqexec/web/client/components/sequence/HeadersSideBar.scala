...
import edu.gemini.seqexec.model.Model.{CloudCover, ImageQuality, Operator, SkyBackground, WaterVapor}
...
import edu.gemini.seqexec.web.client.actions.{UpdateCloudCover, UpdateImageQuality, UpdateOperator, UpdateSkyBackground, UpdateWaterVapor}
