...
object Settings {
  ...
  object LibraryVersions {
    ...
    val opencsv             = "2.1"
    val epicsService        = "1.0.4"
    val gmpCommandRecords   = "0.7.4"
    val giapi               = "1.1.4"
    val giapiJmsUtil        = "0.5.4"
    val giapiJmsProvider    = "1.6.4"
    val giapiCommandsClient = "0.2.4"
    val giapiStatusService  = "0.6.4"
    val gmpStatusGateway    = "0.3.4"
    val gmpStatusDatabase   = "0.3.4"
    val gmpCmdClientBridge  = "0.6.4"
    val guava               = "30.1-jre"
